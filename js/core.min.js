 ...
 * Equal heights
 */
function equalHeightsInit(){function e(){var e=[];$("[data-equal-group]").each(function(){var t=$(this).data("equal-group");e[t]||(e[t]=[]),e[t].push(this)});var t=window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth;t>767?$.each(e,function(){$(this).equalHeights()}):$.each(e,function(){$(this).css("height","auto")})}$(function(){$("[data-equal-group]").each(function(){$(this).contents().wrapAll("<div class='box_inner'></div>")})}),$(window).bind("resize",e).bind("load",e),function(e){e.fn.equalHeights=function(t,n){return tallest=t?t:0,this.each(function(){e(">.box_inner",this).outerHeight()>tallest&&(tallest=e(">.box_inner",this).outerHeight())}),n&&tallest>n&&(tallest=n),this.each(function(){e(this).height(tallest)})}}(jQuery)}
